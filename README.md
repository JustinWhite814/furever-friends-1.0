...
The `applications/new-form.ejs` file is going to use our `pet-form.css` for styling. <details>
<summary>Here's the adjusted <code>pet-form.css</code> code:</summary>
